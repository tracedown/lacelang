...
These are the core executor's obligations toward the extension system. Full extension system compatibility is in the [Extension Checklist](checklist-extensions.md).
