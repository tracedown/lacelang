...
Lace v0.9.3<!-- sv --> grammar. The ANTLR4 grammar (`lacelang.g4`) is the authoritative syntax definition. The EBNF below is the human-readable mirror from the spec.
