...
executor in any programming language — the [conformance test suite](getting-started/executors.md)
ensures they all behave identically. See [Executors](getting-started/executors.md)
for how this works.
