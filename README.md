<p align="center">
  <img src="public/lace-logo-256.png" alt="Lace logo" width="160" height="160">
</p>
...
|---|---|---|---|---|
| [`lacelang-executor`](https://pypi.org/project/lacelang-executor/) | Python | Canonical | 0.9.3<!-- sv --> | [tracedown/lacelang-python-executor](https://github.com/tracedown/lacelang-python-executor) |
| [`lacelang-validator`](https://pypi.org/project/lacelang-validator/) | Python | Canonical | 0.9.3<!-- sv --> | [tracedown/lacelang-python-validator](https://github.com/tracedown/lacelang-python-validator) |
| [`@lacelang/executor`](https://www.npmjs.com/package/@lacelang/executor) | TypeScript | Conformant | 0.9.3<!-- sv --> | [tracedown/lacelang-js-executor](https://github.com/tracedown/lacelang-js-executor) |
| [`@lacelang/validator`](https://www.npmjs.com/package/@lacelang/validator) | TypeScript | Conformant | 0.9.3<!-- sv --> | [tracedown/lacelang-js-validator](https://github.com/tracedown/lacelang-js-validator) |
| `lacelang-kt-executor` | Kotlin | Conformant | 0.9.3<!-- sv --> | [tracedown/lacelang-kotlin-executor](https://github.com/tracedown/lacelang-kotlin-executor) |
| `lacelang-kt-validator` | Kotlin | Conformant | 0.9.3<!-- sv --> | [tracedown/lacelang-kotlin-validator](https://github.com/tracedown/lacelang-kotlin-validator) |
...
Related tooling: [`kotlin-lacetest`](https://github.com/tracedown/kotlin-lacetest) (`dev.lacelang:kotlin-lacetest`) is a Kotlin testing library that runs `.lace` scripts as JUnit 5 test cases against a target service (often a Testcontainers instance) — an `expect()` failure fails the test, a `check()` failure is logged. It builds on the Kotlin executor and validator.
...
a single version line — currently **0.9.3<!-- sv -->** (pre-release). Any change to
